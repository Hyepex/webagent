...
const SEED_TEMPLATES = [
  ...
  },
  {
    ...
    category: "travel",
    icon: "\u2708\uFE0F",
    recipe_id: "google_flights_search",
    description: "Search flight prices on Google Flights",
    ...
    variables: [
      ...
      { name: "date", label: "Departure date", type: "text", placeholder: "15/04/2026 or leave empty for tomorrow" },
      { name: "returnDate", label: "Return date", type: "text", placeholder: "22/04/2026 or leave empty", showWhen: { field: "trip_type", value: "Round trip" } },
    ],
  },
  {
    name: "Job Search",
