...
const config = {
  ...
  agent: {
    ...
    settleDelay: parseInt(process.env.SETTLE_DELAY) || 800,
    networkIdleTimeout: parseInt(process.env.NETWORK_IDLE_TIMEOUT) || 3000,
    maxElements: parseInt(process.env.MAX_ELEMENTS) || 10,
    maxVisibleText: parseInt(process.env.MAX_VISIBLE_TEXT) || 400,
    maxGetText: parseInt(process.env.MAX_GET_TEXT) || 800,
